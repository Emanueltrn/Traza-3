...
//        }
        ...
        ArticuloInsumo coca = ArticuloInsumo.builder()
                ...
                .unidadMedida(litro)
                .categoria(bebidas)
                .sucursales(new HashSet<>(Set.of(sucursal2, sucursal4)))
                .build();
        ...
        ArticuloManufacturado pizzaHawaina = ArticuloManufacturado.builder()
                ...
                .categoria(pizzas)
                .unidadMedida(kg)
                .imagenes(new HashSet<>(Set.of(img1, img2, img3)))//le pasa la lista
                .articuloManufacturadoDetalles(new HashSet<>(Set.of(detalle1PizzaHawaina, detalle2PizzaHawaina, detalle3PizzaHawaina)))
                .sucursales(new HashSet<>(Set.of(sucursal1, sucursal2, sucursal3, sucursal4)))
                .build();
        ...
        ArticuloManufacturado pizzaHawainaActualizada = ArticuloManufacturado.builder()
                ...
                .precioVenta(14.0) //cambie precio
